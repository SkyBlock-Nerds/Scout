...
import net.hypixel.nerdbot.scout.handler.status.StatusPageResponse;
...
public class StatusPageEmbedFactory {
    ...
    public JsonObject createIncidentEmbed(StatusPageResponse.Incident incident, StatusPageEventType eventType) {
        String title = eventType.getEmoji() + " " + incident.getName();
        Color color = getIncidentColor(incident.getImpact(), incident.getStatus());
        ...
        return DiscordWebhook.createEmbed(title, incident.getShortlink(), description.toString(), color.getRGB() & 0xFFFFFF);
    }

    public JsonObject createMaintenanceEmbed(StatusPageResponse.ScheduledMaintenance maintenance, StatusPageEventType eventType) {
        String title = eventType.getEmoji() + " " + maintenance.getName();
        Color color = getMaintenanceColor(maintenance.getStatus());
        ...
        return DiscordWebhook.createEmbed(title, maintenance.getShortlink(), description.toString(), color.getRGB() & 0xFFFFFF);
    }
