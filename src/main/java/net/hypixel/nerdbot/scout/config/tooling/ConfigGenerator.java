package net.hypixel.nerdbot.scout.config.tooling;
...
public class ConfigGenerator {
    ...
    public static void main(String[] args) {
        ...
        try {
            WatcherAppConfig config = generator.generate(WatcherAppConfig.class);
            String json = DataSerialization.GSON.newBuilder()
                .setPrettyPrinting()
                .create()
                .toJson(config);
